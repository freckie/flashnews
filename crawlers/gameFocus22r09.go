...
func (c GameFocus22r09) GetList(number int) ([]models.NewsItem, error) {
	...
	// Request
	req, err := http.Get(gameFocus22r09CommonURL)
	if err != nil {
		return result, err
	}
	...
	wrapper.ChildrenFiltered("tr").Each(func(i int, sel *goquery.Selection) {
		...
		url := gameFocus22r09ItemURL + href
...
func (c GameFocus22r09) GetContents(item *models.NewsItem) error {
	// Request
