...
url = 'http://www.newstown.co.kr/news/articleList.html?page=1&sc_section_code=S1N3'
...
for item in items[0:10]:
    ...
    href = 'http://www.newstown.co.kr' + a_tag['href'].strip()
    ...
    wrapper2 = bs2.find('div', id='_article')
